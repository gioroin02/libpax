...
#include "./display.h"
    ...
    #include "../../windows/display/display.c"

    #define __pax_display_create__  pax_windows_display_create
    ...
    #define __pax_display_buffer_length__  pax_windows_display_buffer_length
    #define __pax_display_buffer_width__   pax_windows_display_buffer_width
    #define __pax_display_buffer_height__  pax_windows_display_buffer_height
    #define __pax_display_buffer_stride__  pax_windows_display_buffer_stride
    #define __pax_display_buffer_write__   pax_windows_display_buffer_write
    #define __pax_display_buffer_read__    pax_windows_display_buffer_read
...
{
    return __pax_display_buffer_write__(self, x, y, r, g, b, a);
}

paxb8
pax_display_buffer_read(Pax_Display_Buffer self, paxiword x, paxiword y, paxu8* r, paxu8* g, paxu8* b, paxu8* a)
{
    return __pax_display_buffer_read__(self, x, y, r, g, b, a);
}
