#ifndef PAX_WINDOWS_NETWORK_SOCKET_UDP_C
#define PAX_WINDOWS_NETWORK_SOCKET_UDP_C

#include "./socket_udp.h"
#include "./helper.c"

struct Pax_Windows_Socket_UDP
{
    SOCKET        handle;
    Pax_Sock_Data data;
};
...
pax_windows_socket_udp_create(Pax_Arena* arena, Pax_Addr_Kind kind)
{
    ...
    Pax_Windows_Socket_UDP* result =
        pax_arena_reserve(arena, Pax_Windows_Socket_UDP, 1);
...
#endif // PAX_WINDOWS_NETWORK_SOCKET_UDP_C
