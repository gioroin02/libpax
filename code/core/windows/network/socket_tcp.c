#ifndef PAX_WINDOWS_NETWORK_SOCKET_TCP_C
#define PAX_WINDOWS_NETWORK_SOCKET_TCP_C

#include "./socket_tcp.h"
#include "./helper.c"

struct Pax_Windows_Socket_TCP
{
    SOCKET        handle;
    Pax_Sock_Data data;
};
...
pax_windows_socket_tcp_create(Pax_Arena* arena, Pax_Addr_Kind kind)
{
    ...
    Pax_Windows_Socket_TCP* result =
        pax_arena_reserve(arena, Pax_Windows_Socket_TCP, 1);
...
#endif // PAX_WINDOWS_NETWORK_SOCKET_TCP_C
