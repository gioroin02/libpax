#ifndef PAX_WINDOWS_STORAGE_DIRECTORY_C
#define PAX_WINDOWS_STORAGE_DIRECTORY_C
...
pax_windows_current_directory(Pax_Arena* arena, paxiword length)
{
    ...
    paxiword size =
        pax_windows_current_directory_memory8(arena, memory, length);
...
#endif // PAX_WINDOWS_STORAGE_DIRECTORY_C
