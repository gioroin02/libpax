#ifndef PAX_WINDOWS_STORAGE_FILE_C
#define PAX_WINDOWS_STORAGE_FILE_C
...
pax_windows_default_input(Pax_Arena* arena)
{
    ...
    Pax_Windows_File* result =
        pax_arena_reserve(arena, Pax_Windows_File, 1);
...
pax_windows_file_create(Pax_Arena* arena, Pax_String8 base, Pax_String8 name, Pax_File_Mode mode)
{
    ...
    Pax_Windows_File* result = pax_arena_reserve(arena, Pax_Windows_File, 1);
...
#endif // PAX_WINDOWS_STORAGE_FILE_C
