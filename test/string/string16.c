...
main(int argc, char** argv)
{
    ...
    Pax_String16 string0 = pax_string16_copy_memory16(&arena,
        pax_block_from_vargs(paxu16, 'c', 'i', 'a', 'o'), 4);

    Pax_String16 string1 = pax_string16_copy_unicode(&arena, 0x1f600);

    for (paxiword i = 0; i < string0.length; i += 1) {
        paxu16 item = pax_string16_peek_or_none(string0, i);
