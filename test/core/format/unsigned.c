...
void
test_case(Pax_Arena* arena, paxuword value)
{
    ...
    Pax_String8 string = pax_string8_from_unsigned(arena, value, radix, flags);

    paxb8 state  = pax_unsigned_from_string8(string, &result, radix, flags);
